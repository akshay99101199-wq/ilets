...
@section('content')
    ...
    <style>
        .hero-section {
            position: relative;
            padding: 61px 0;
            background: linear-gradient(rgba(5, 20, 40, .82), rgb(5 20 40 / 54%)), url('public/assets/assets/img/tourist_visa.jpg');
    ...
    <section class="about-section py-5">
        <div class="container">
            ...
            <div class="text-center mb-5">
                <h2 class="fw-bold">Why Choose a <span class="text-primary">Tourist  Visa?</span></h2>
                <p class="text-muted">
                   A Tourist Visa is your gateway to exploring new destinations, allowing you to travel and enjoy different cultures while building unforgettable memories. It’s the first step toward a successful global travel experience.
                </p>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mb-4">
                    <h4 class="fw-semibold mb-3">
                      Explore the World Freely: Your Gateway to Hassle-Free Travel
                    </h4>
                    <p class="text-muted">
                        At ShiftAbroad Visa Services, we make your travel dreams a reality with a hassle-free Tourist Visa process. Whether it’s a short getaway, a family vacation, or an adventure abroad, our experts handle everything — from documentation to approval — so you can focus on exploring new countries, cultures, and cuisines.
                    </p>

                    <div class="highlight-box mt-4">
                        <p>
                            💡 <strong>Why Choose Us?</strong><br>
                          A Tourist Visa is your key to global exploration. It allows you to visit another country for leisure, recreation, or sightseeing purposes, giving you the freedom to travel and experience life beyond borders. Top Benefits:
                        </p>
                    </div>
                </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="feature-card">
                                ...
                                <h6>Easy International Travel</h6>
                                <p>Visit your dream destinations with hassle-free processing.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="feature-card">
                                ...
                                <h6>Flexible Stay Options</h6>
                                <p>Choose from short-term or extended stay visas depending on your plan.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="feature-card">
                                ...
                                <h6>Freedom to Explore</h6>
                                <p>Travel freely across cities, landmarks, and cultural sites.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="feature-card">
                                ...
                                <h6>Ideal for Families & Groups</h6>
    ...
    <section class="why-choose py-5">
        <div class="container">
            ...
            <!-- Title -->
            <div class="text-center mb-5">
                <h2 class="fw-bold">Our <span>Tourist  Visa</span> Assistance Includes:</h2>
                <p class="text-muted">We provide comprehensive support to ensure your tourist visa application is smooth
                    and successful.</p>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="choose-card">
                        ...
                        <h5>Application Form Assistance</h5>
                        <p> Complete and accurate visa filing for faster processing.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="choose-card">
                        ...
                        <p>Ensure all travel documents meet embassy standards.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="choose-card">
                        ...
                        <h5>Travel Itinerary Support</h5>
                        <p>Guidance on trip plans, tickets, and accommodation proof.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="choose-card">
                        ...
                        <p>Expert documentation and embassy coordination ensure fast approvals.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="choose-card">
                        ...
                        <p>Tips for travel insurance, packing, and customs clearance.</p>
                    </div>
                </div>
                 <!-- Card 2 -->
                <div class="col-lg-4 col-md-6">
                    <div class="choose-card">
                        ...
                        <h5>Embassy Appointment Scheduling</h5>
                        <p> Secure your slots on time for a stress-free experience.</p>
                    </div>
                </div>
            ...
            <div class="accordion custom-faq" id="faq">
                ...
                <div class="accordion-item">
                    ...
                    <div id="q1" class="accordion-collapse collapse show" aria-labelledby="heading1"
                        ...
                        <div class="accordion-body">
                          Apply at least 4–6 weeks before your travel date to ensure timely approval.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="q2" class="accordion-collapse collapse" aria-labelledby="heading2"
                        ...
                        <div class="accordion-body">
                          Yes, many countries allow extensions depending on local immigration policies.
                        </div>
                    </div>
                </div>
...
Do I need travel insurance?
                    ...
                    <div id="q3" class="accordion-collapse collapse" aria-labelledby="heading3"
                        ...
                        <div class="accordion-body">
                       Yes, most countries require valid travel and health insurance as part of your application.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="q4" class="accordion-collapse collapse" aria-labelledby="heading4"
                        ...
                        <div class="accordion-body">
Our experts review rejection reasons and help you reapply with corrected documentation.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="q5" class="accordion-collapse collapse" aria-labelledby="heading5"
                        ...
                        <div class="accordion-body">
                         Yes — depending on your visa type (like Schengen), you can visit multiple destinations with a single approval.
                        </div>
                    </div>
                </div>
