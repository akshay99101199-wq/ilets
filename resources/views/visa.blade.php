@extends('layouts.app')
@section('title', 'Visa Services | Seeking Adventure? Thrills and Opportunities Await!')
@section('content')
    ...
    <div class="container">
        <div class="row text-center g-5">
            ...
            <div class="col-lg-12">
                ...
                <h1 class="hero-title">
                    Get the Right Visa  <br>
                    <span>for Your Global Dream</span>
                </h1>

                <p class="hero-text">
                    ShiftAbroad provides tailored visa services for study, work, travel, or settlement abroad with simplified processes.
                </p>
            ...
            <div class="col-lg-6">
                <div class="visa-card">
                    <div class="row align-items-center g-4">
                        ...
                        <div class="col-md-5">
                            <img src="https://images.unsplash.com/photo-1521791136064-7986c2920216?q=80&w=1200&auto=format&fit=crop" class="visa-img" alt="">
                        </div>
            ...
            <div class="col-lg-6">
                <div class="visa-card">
                    <div class="row align-items-center g-4">
                        ...
                        <div class="col-md-5">
                            <img src="https://remote.co/wp-content/uploads/2020/03/18101122/work-visa.png" class="visa-img" alt="">
                        </div>
            ...
            <div class="col-lg-6">
                <div class="visa-card">
                    <div class="row align-items-center g-4">
                        ...
                        <div class="col-md-5">
                            <img src="https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?q=80&w=1200&auto=format&fit=crop" class="visa-img" alt="">
                        </div>
            ...
            <div class="col-lg-6">
                <div class="visa-card">
                    <div class="row align-items-center g-4">
                        ...
                        <div class="col-md-5">
                            <img src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=1200&auto=format&fit=crop" class="visa-img" alt="">
                        </div>
