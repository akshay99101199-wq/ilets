                    ...
                    <div class="col-lg-6">
                        <div class="vm-content">
                            ...
                            <p class="text-muted mb-4">
                                We aim to create a world where language is not a barrier but a bridge to global
                                opportunities.
                            </p>
                            <ul>
                ...
                <div class="row align-items-center g-5 flex-lg-row-reverse">
                    ...
                    <div class="col-lg-6">
                        <div class="vm-content">
                            <h2>Our Mission</h2>
                            <p class="text-muted mb-4">
                                Our mission is to deliver high-quality language training that transforms learning into
                                real-world success.
                            </p>
                            <ul>
                ...
                <div class="accordion custom-faq" id="faq">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="heading1">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                ...
                                What documents are usually required while applying for an international business visa
                                process?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="q3" class="accordion-collapse collapse" aria-labelledby="heading3"
                            ...
                            <div class="accordion-body">
                                Processing time varies by country, but most applications are completed within 7–15 working
                                days.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="heading5">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Is travel insurance compulsory and mandatory for international business visa approval
                                purposes?
                            </button>
                        </h2>
