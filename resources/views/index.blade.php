            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="visa-image">
                        <img src="https://images.unsplash.com/photo-1521295121783-8a321d551ad2?q=80&w=1200&auto=format&fit=crop" alt="Visa Travel">
                    </div>
                </div>
...
<p>Get expert help for studying abroad with top universities and high visa approval rate.</p>
<a href="#" class="visa-btn" data-bs-toggle="modal" data-bs-target="#popupForm">Apply Now</a>
</div>
</div>
...
<!-- CONTROLS -->
<button class="carousel-control-prev" type="button" data-bs-target="#visaSliderClean" data-bs-slide="prev">
<span class="carousel-control-prev-icon"></span>
</button>

<button class="carousel-control-next" type="button" data-bs-target="#visaSliderClean" data-bs-slide="next">
        ...
        <div class="row align-items-center gy-5">
            ...
            <div class="col-lg-6 order-lg-1" data-aos="fade-right">
                ...
                <p class="text-muted mb-4">
                    We believe every learner is unique. At <strong>The Assigner</strong>, we design customized courses with modern techniques and full support to help you achieve your goals faster.
                </p>
        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="100">
                <div class="icon-box course-card h-100 text-center">
                    ...
                    <p>
                        Improve your fluency, pronunciation, and vocabulary. Gain confidence for interviews and daily communication.
                    </p>
            ...
            <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                <div class="icon-box course-card h-100 text-center">
                    ...
                    <p>
                        Learn German A1 to B2 with practical speaking, grammar, and listening training for students and professionals.
                    </p>
            ...
            <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="300">
                <div class="icon-box course-card h-100 text-center">
                    ...
                    <p>
                        Comprehensive PTE preparation with expert trainers, AI mock tests, and official scoring pattern practice.
                    </p>
            ...
            <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="400">
                <div class="icon-box course-card h-100 text-center">
                    ...
                    <p>
                        Master Listening, Reading, Writing, and Speaking with band-focused strategies and daily practice sessions.
                    </p>
        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="course-item">
                    <img src="{{ asset('public/assets/assets/img/ielts.jpg') }}" class="img-fluid course-img" alt="Counselling">
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                <div class="course-item">
                    <img src="{{ asset('public/assets/assets/img/test.jpg') }}" class="img-fluid course-img" alt="Practice Test">
                    <div class="course-content">
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                <div class="course-item">
                    <img src="{{ asset('public/assets/assets/img/payment.jpg') }}" class="img-fluid course-img" alt="Payment Options">
                    <div class="course-content">
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                <div class="course-item">
                    <img src="{{ asset('public/assets/assets/img/24into7.webp') }}" class="img-fluid course-img" alt="Learning Portal">
                    <div class="course-content">
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
                <div class="course-item">
                    <img src="{{ asset('public/assets/assets/img/result.jpg') }}" class="img-fluid course-img" alt="Results Focused">
                    <div class="course-content">
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in-up" data-aos-delay="300">
                <div class="course-item">
                    <img src="{{ asset('public/assets/assets/img/visapage-2.avif') }}" class="img-fluid course-img" alt="Expert Trainers">
                    <div class="course-content">
        ...
        <div class="swiper init-swiper">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="{{ 'public/assets/' }}assets/img/sssds.jpg" class="testimonial-img" alt="">
                  <h3>Vishal </h3>
                  <h4>New Zealand</h4>
                  <div class="stars">
                    <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
