...
<section class="pte-section section-light">
  <div class=" checking">
    ...
    <div class="container mx-auto pte-hero text-center text-white mb-5">
      ...
      <p class="mb-4">
        Looking to crack the IELTS on your first try? The Assigner is the leading choice for offline IELTS coaching in Karnal, known for its results-focused training and strong student success record. With certified trainers, up-to-date materials, and mock test-based learning, we help you reach your target band with confidence. Be it higher education or permanent residency, The Assigner is here to guide you toward IELTS success.
    ...
    <div class="row g-4">
      ...
      <div class="col-md-4">
        <div class="assigner-card">
          ...
          <p>
Learn from certified instructors with proven results and deep understanding of exam patterns.</p>
        </div>
      </div>
