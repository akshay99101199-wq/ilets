...
.why-card:hover .why-card h5, .why-card:hover .why-card p{
  color:#fff !important;
}
...
/* COLOR VARIANTS */
.listening { background: linear-gradient(45deg, #6f42c1, #9b5de5); }
.reading { background: linear-gradient(45deg, #fd7e14, #ff9f43); }
.writing { background: linear-gradient(45deg, #198754, #20c997); }
.speaking { background: linear-gradient(45deg, #0d6efd, #4dabf7); }
...
<section class="pte-section section-light">
  <div class=" checking">
    ...
    <div class="pte-hero text-center text-white mb-5">
      ...
      <p class="mb-4">
        The Assigner offers expert-led offline training with real exam simulations, updated study materials, and flexible batches. Whether for academics or immigration, our certified trainers and structured approach make us the top choice for affordable PTE coaching in Karnal.
      </p>
    ...
    <div class="row  align-items-center g-5">
      ...
      <div class="col-lg-12">
        <div class="pte-content mt-4 text-center">
          ...
          <p>
            <strong>PTE, or the Pearson </strong> Test of English, is a digital language assessment that measures your skills in speaking, writing, reading, and listening. Recognized globally by academic institutions, governments, and employers, it is ideal for those planning to study or migrate to English-speaking countries. Whether you’re a student or working professional, offline PTE coaching in Haryana at The Assigner helps you prepare effectively with strategies tailored to real-world scenarios.
          </p>
        </div>
      </div>
     <div class="col-lg-6">
     <div class="pte-features">
      ...
      <div class="col-lg-6">
        <div class="pte-card">
          <h4 class="mb-2"><strong>Why Students Prefer PTE?</strong></h4>
          ...
          <ul>
            ...
            <div class="col-md-6">
            <li class="mb-0">🌍 Accepted worldwide</li>
            </div>
            <div class="col-md-6">
            <li class="mb-0">📅 Multiple test dates</li>
            </div>
