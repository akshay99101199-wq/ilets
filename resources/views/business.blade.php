...
@section('content')
    ...
    <style>
        ...
        .hero-section {
            position: relative;
            padding: 61px 0;
            background: linear-gradient(rgba(5, 20, 40, .82), rgb(5 20 40 / 54%)), url('public/assets/assets/img/business_visa.jpg');
        ...
        <div class="container">
            <div class="row text-center g-5">
                ...
                <div class="col-lg-12">
                    ...
                    <p class="hero-text">
                        Get expert guidance to secure your business visa quickly — from <br />documentation to successful
                        approval.
                    </p>
                </div>
    ...
    <section class="about-section py-5">
        <div class="container">
            ...
            <div class="text-center mb-5">
                <h2 class="fw-bold">Why Choose a <span class="text-primary">Business Visa?</span></h2>
                <p class="text-muted">
                    A business visa opens doors to international growth and networking. It allows you to:
                </p>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mb-4">
                    <h4 class="fw-semibold mb-3">
                        Explore Global Opportunities with a Business Visa
                    </h4>
                    <p class="text-muted">
                        The world is full of possibilities for entrepreneurs and investors ready to expand their horizons.
                        At ShiftAbroad Visa Services, we simplify the business visa process — making it faster, more
                        transparent, and completely stress-free. Whether you’re attending international conferences,
                        exploring partnerships, or setting up operations abroad, our consultants guide you through every
                        requirement, from documentation to final approval.
                    </p>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="feature-card">
                                ...
                                <p>Attend business meetings, exhibitions, and trade events.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="feature-card">
                                ...
                                <p>Explore investment and expansion opportunities</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="feature-card">
                                ...
                                <p>Build professional connections worldwide</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="feature-card">
                                ...
                                <h6>Global Representation:</h6>
                                <p>Represent your company or startup globally</p>
                            </div>
                        </div>
    ...
    <section class="why-choose py-5">
        <div class="container">
            ...
            <!-- Title -->
            <div class="text-center mb-5">
                <h2 class="fw-bold">Our <span>Business Visa</span> Support Includes:</h2>
                <p class="text-muted">We provide comprehensive support to ensure your business visa application is smooth
                    and successful.</p>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="choose-card">
                        ...
                        <h5>Flight Booking Assistance</h5>
                        <p>We help you plan your travel with verified airline partners to ensure your business trip runs on
                            schedule.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="choose-card">
                        ...
                        <h5>Car Rental & Local Transport</h5>
                        <p>Get easy access to trusted transport providers abroad — convenient, affordable, and safe.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="choose-card">
                        ...
                        <h5>Travel Planning & Itinerary Design</h5>
                        <p>From meetings to leisure activities, we design customized travel plans that fit your business
                ...
                <div class="accordion-item">
                    ...
                    <div id="q1" class="accordion-collapse collapse show" aria-labelledby="heading1"
                        ...
                        <div class="accordion-body">
                            You’ll typically need an invitation letter, valid passport, business registration proof,
                            financial documents, and travel details.
                        </div>
                    </div>
                </div>
